...
class Gui:
    ...
    def create_fuel_widget(self, parent):
        result = Box(parent)
        result.set_border(4, "darkgreen")
        Text(result, "FUEL", size='32', color="lightgreen")
        ...
        Text(total_box, "L", size='32', color="lightgreen", align="left")
        ...
        Text(last_hour_box, "gph", size='32', color="lightgreen", align="left")
        ...
        Text(last_lap_box, "ml", size='32', color="lightgreen", align="left")
